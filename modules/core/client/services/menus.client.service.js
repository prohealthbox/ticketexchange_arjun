...
angular.module('core').service('Menus', [
    function () {
        ...
        //Define Admin Panel roles
        this.adminPanelRoles = ['admin'];
        ...
        // Add menu item object - store admin item in separate object
        this.addMenuAdminItem = function (menuId, options) {
            options = options || {};
            ...
            // Push new menu item
            if (options.roles !== null && typeof options.roles !== 'undefined' && options.roles.indexOf('admin') > -1) {
                this.menus[menuId].adminItems.push({
                    title: options.title || '',
                    state: options.state || '',
                    icon: options.icon || '',
                    type: options.type || 'item',
